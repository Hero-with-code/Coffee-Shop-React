          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Premium blend coffee combines high-quality beans from various regions, expertly roasted to enhance their unique flavors. This creates a rich, balanced cup perfect for discerning coffee enthusiasts.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    For tea lovers, every cup is a journey. From the delicate notes of green tea to the robust flavor of black tea, each variety offers a unique experience.
                    </p>
                  </div>
                </div>
              </div>
